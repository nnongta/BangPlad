...
const translations = {
  th: {
    ...
    subtitle: "",
    description:
      "โครงการนี้เป็นส่วนหนึ่งของรายวิชา นกศ301 การบริหารโครงการศิลปวัฒนธรรมและการระดมทุน  โดยมีวัตถุประสงค์ในการจัดทำขึ้นเพื่อ อนุรักษ์และเผยแพร่เอกลักษณ์ท้องถิ่นของย่านบางพลัดที่จะเก็บรวบรวมข้อมูลเกี่ยวกับสถาปัตยกรรม วัฒนธรรม และความโดดเด่นเฉพาะตัวของย่านบางพลัด ทำให้ผู้คนตระหนักถึงคุณค่าของพื้นที่ อีกทั้งยังเป็นการเพิ่มการเข้าถึงข้อมูลของสถานที่สำคัญเพื่อให้ผู้ที่อยู่อาศัย นักท่องเที่ยว และผู้ที่สนใจ สามารถค้นหาสถานที่สำคัญในย่านบางพลัดได้ง่ายขึ้น เช่น วัด โรงเรียน ร้านอาหาร คาเฟ และสถานที่ท่องเที่ยวสาธารณะ",
    subscription:
      "จัดทำขึ้นโดยนิสิต ชั้นปีที่3 สาขานวัตกรรมการจัดการศิลปวัฒนธรรม คณะศิลปกรรมศาสตร์ มหาวิทยาลัยศรีนครินทรวิโรฒ",
  },
  en: {
    title: "Our",
    subtitle: "Project",
