...
const translations = {
  th: {
    ...
    subscription:
      "นกศ301 การบริหารโครงการศิลปวัฒนธรรมและการระดมทุน จัดทำขึ้นโดยนิสิต ชั้นปีที่3 สาขานวัตกรรมการจัดการศิลปวัฒนธรรม คณะศิลปกรรมศาสตร์ มหาวิทยาลัยศรีนครินทรวิโรฒ",
  },
  en: {
    title: "Our",
    subtitle: "Project",
